                ...
                <h4>{myUser.name.split(" ")[0]}</h4>
                 <input type="checkbox" className={s.checkbox} id='check1'/>
                    <label for="check1" className={s.menu}>
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M20 12V14H0V12H20ZM20 6V8H0V6H20ZM20 0V2H0V0H20Z" fill="#4F4E4E"/>
                        </svg>
                    </label> 
